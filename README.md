...
<img src="OS_Images/CPU_SCHEDULING.png" width="800" title="Program Flow1">
<img src="OS_Images/CPU_SCHEDULING_CHOICE.png" width="800" title="Program Flow2">
After choosing, the users will then be prompted regarding the CPU scheduling algorithm that they will use. 
<img src="OS_Images/DISK_SCHEDULING_CHOICE.png" width="800" title="Program Flow3">
...
<img src="OS_Images/PRIORITY_SCHEDULING.png" width="800" title="Priority (Preemptive)">
CPU Scheduling - Shortest Job First (Non-preemptive)
<img src="/OS_Images/SJF.png" width="800" title="Shortest Job First (Non-preemptive)">
Disk Scheduling - Scan (left-first)
<img src="OS_Images/SCAN.png" width="800" title="Scan (left-first)">
Disk Scheduling - Shortest Seek Time First
<img src="OS_Images/SSTF.png" width="800" title="Shortest Seek Time First">
